            ...
            >
                ...
                <div className="p-8 sm:p-12 lg:p-14 flex flex-col justify-center text-center">
                    <header className="mb-8">
                        ...
                        <h2 className="font-chinese text-2xl text-atelier-text mb-3 font-normal tracking-tight">私人妝髮諮詢</h2>
                        <p className="font-chinese font-light text-sm text-atelier-muted leading-relaxed max-w-sm mx-auto">
                            歡迎留下您的微信號，我會與您聯絡。
                        </p>
                    </header>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex justify-center">
                            <input
                                ...
                                className="modal-input font-chinese w-full text-center"
                        ...
                        <div className="flex justify-center">
                            <button
                                ...
                                className={cn(
                                    "w-full py-4 px-8 font-chinese text-[15px] font-medium transition-colors duration-200 border cursor-pointer",
                                    isError
